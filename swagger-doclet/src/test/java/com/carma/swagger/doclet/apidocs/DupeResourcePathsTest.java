...
public class DupeResourcePathsTest {
	...
	public void testStart() throws IOException {
		...
		final ResourceListing expectedListing = loadFixture("/fixtures/duperesourcepaths/service.json", ResourceListing.class);
		verify(this.recorderMock).record(any(File.class), eq(expectedListing));

		final ApiDeclaration expectedDeclaration = loadFixture("/fixtures/duperesourcepaths/resource.json", ApiDeclaration.class);
