...
public class SubResourceBTest {
	...
	public void testStart() throws IOException {
		...
		final ResourceListing expectedListing = loadFixture("/fixtures/subresourceb/service.json", ResourceListing.class);
		verify(this.recorderMock).record(any(File.class), eq(expectedListing));

		final ApiDeclaration expectedDeclaration = loadFixture("/fixtures/subresourceb/foo.json", ApiDeclaration.class);
