...
public class Issue52Test {
	...
	public void testStart() throws IOException {
		...
		final ResourceListing expectedListing = loadFixture("/fixtures/issue52/service.json", ResourceListing.class);
		verify(this.recorderMock).record(any(File.class), eq(expectedListing));

		final ApiDeclaration expectedDeclaration = loadFixture("/fixtures/issue52/bidir.json", ApiDeclaration.class);
