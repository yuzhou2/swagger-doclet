...
public class SubResourceTest {
	...
	public void testStart() throws IOException {
		...
		final ResourceListing expectedListing = loadFixture("/fixtures/subresource/service.json", ResourceListing.class);
		verify(this.recorderMock).record(any(File.class), eq(expectedListing));

		final ApiDeclaration expectedDeclaration = loadFixture("/fixtures/subresource/a.json", ApiDeclaration.class);
